...
class SoundLushPostTypeTemplate {

	private static $post_type;

	public static function get( $id ) {
		return SoundlushPostType::get( $id );
	}
	public static function get_all( $options=array() ) {
		return SoundlushPostType::get_all( static::$post_type, $options );
	}
	public static function get_recent( $options=array() ) {
		return SoundlushPostType::get_recent( static::$post_type, $options );
	}
	public static function get_list( $options=array(), $no_value_label='' ) {
		return SoundlushPostType::get_list( static::$post_type, $options, $no_value_label );
	}
	public static function get_posts_by_meta( $meta_key='', $meta_value='', $options=array() ) {
		return SoundlushPostType::get_posts_by_meta( static::$post_type, $meta_key, $meta_value, $options);
	}
	public static function get_posts_by_meta_query( $meta_query, $options=array() ) {
		return SoundlushPostType::get_posts_by_meta_query( static::$post_type, $meta_query, $options);
	}
